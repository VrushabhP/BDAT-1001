...
namespace CSV.Models
{
    public class Student
    {
        ...
        //Create Json Object of Student Data
        public JObject ToJSON()
        {
            //var studentJSONString = '{"StudentID" : "{StudentID}" ,'{ StudentID}
            //', 'FirstName' : 'Joe', 'LastName' : 'Smith'}';

            JObject result = new JObject(
                new JProperty("Student ID", $"{StudentId}"),
                new JProperty("First Name", $"{FirstName}"),
                new JProperty("Last Name", $"{LastName}"),
                new JProperty("Date Of Birth", $"{DateOfBirthDT.ToShortDateString()}"),
                new JProperty("Image Data", $"{ImageData}"));
            return result;
        }
